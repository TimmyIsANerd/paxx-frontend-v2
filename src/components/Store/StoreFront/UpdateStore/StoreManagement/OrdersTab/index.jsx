  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <button className="px-4 py-2 text-gray-400 bg-[#131B2C] rounded-lg border border-gray-800 hover:text-gray-300 transition-colors">
          Export
        </button>
      </div>
      ...
      <div className="grid grid-cols-2 gap-6">
        ...
        <div className="bg-[#131B2C] rounded-lg border border-gray-800 p-6">
          ...
          <p className="text-2xl font-semibold text-white">NGN 5,000.00</p>
        </div>
      </div>
    </div>
  );
